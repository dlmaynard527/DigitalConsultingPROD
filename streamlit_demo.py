...
d1.text((400, 300), str(date_time), fill=(255, 255, 255),font=font2)
d1.text((600, 400), ticker, fill=(255, 255, 255),font=font)
d1.text((250, 500), "Implied Evaluation: $"+str(round(value,4)), fill=(255, 255, 255),font=font)
st.image(img)